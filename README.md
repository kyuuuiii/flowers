...
## Распределение задач
- Скрипникова С. О. - Backend-разработчик - архитектура на Django: настройка проекта, проектирование базы данных, модели, миграции, маршрутизация, контроллеры, реализация бизнес-логики (корзина, заказы, фильтрация, аутентификация), настройка админ-панели, обеспечение безопасности, перенос частей верстки в шаблоны с выделением динамического содержимого.
- Хавронина В. А. - Дизайнер, аналитик: создание макетов страниц, обеспечение доступности, ребрендинг; аналитика, оценка рисков, проверка соответствия ТЗ
- Рашидов Д. Х. - Frontend-разработчик: рефакторинг статических HTML/CSS/JS, исправление ошибок адаптивности, обеспечение доступности (alt, клавиатурная навигация)
