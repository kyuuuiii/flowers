...
if (window.catalogModuleInitialized) {
    console.log('Catalog module already initialized');
} else {
    window.catalogModuleInitialized = true;
    ...
    function renderCatalogProducts() {
        ...
        document.querySelectorAll('.product-card__view').forEach(btn => btn.addEventListener('click', (e) => { e.stopPropagation(); window.location.href = `/product/${btn.dataset.id}`; }));
        document.querySelectorAll('.product-card').forEach(card => card.addEventListener('click', () => window.location.href = `/product/${card.dataset.id}`));
    }
