...
let articlesData = [
    ...
    { id: 3, title: 'Тенденции флористики 2026: какие букеты будут в моде', excerpt: 'Обзор главных трендов в мире флористики в этом году.', image: 'https://images.pexels.com/photos/6943690/pexels-photo-6943690.jpeg?auto=compress&cs=tinysrgb&w=800', date: '1 апреля 2026', category: 'Новости', views: 1500, content: '<p>Полный текст статьи о трендах флористики...</p>' }
];

let testimonialsData = [
    { name: 'Екатерина Санникова', city: 'Шахты', text: 'Заказывала букет на юбилей мамы. Цветы были свежие, красивые, доставка точно в срок. Мама была в восторге!', rating: 5 },
    { name: 'Виктор Алиров', city: 'Ростов-на-Дону', text: 'Потрясающий сервис! Заказал букет для девушки с доставкой в офис. Все прошло идеально.', rating: 5 },
    { name: 'Елена Егорова', city: 'Туапсе', text: 'Регулярно заказываю цветы для бизнес-партнеров. Всегда профессиональный подход.', rating: 4.5 }
];

let reviewsData = [
    { id: 1, productId: 1, author: 'Анна В.', rating: 5, text: 'Очень красивый букет! Цветы свежие, доставили вовремя.', date: '15.03.2025' },
    { id: 2, productId: 1, author: 'Григорий Л.', rating: 4, text: 'Букет понравился, но курьер немного опоздал.', date: '10.03.2025' }
];
